...
module.exports = {
  ...
  networks: {
    ...
    zilTestnet: {
      url: "https://evm-api-dev.zilliqa.com/",//"https://evm-api-dev.zilliqa.com/",  //https://dev-api.zilliqa.com
      // gasPrice: mainnetGwei * 8000000000,
      chainId: 33101,
      accounts: {
        mnemonic: mnemonic(),
      },
...
task("accounts", "Prints the list of accounts", async (_, { ethers }) => {
  ...
  // const wallet = ethers.Wallet.fromMnemonic(accounts.mnemonic, accounts.path);
